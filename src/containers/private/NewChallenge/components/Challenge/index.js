...
const Challenge = ({
  ...
  useEffect(() => {
    ...
    if (skillsData) {
      // skills.filter((x) => !skillsChange.includes(x));
  ...
  useEffect(() => {
    ...
    console.log("skillsChange useEffect");
  }, [skillsChange]);

  const handleRemoveSkill = (skill) => {
    setSkillsChange((prev) =>
      [...prev].filter((item) => item.value !== skill.value)
    );
    setSkills((prev) => [...prev, skill]);
  };
              ...
              <InputGroup key={index}>
                <div style={{ width: "50%" }}>
                  ...
                  <Input
                    ...
                    errors={errors}
                    validate={errors?.mentors?.[index]?.name?.message}
                ...
                <div style={{ width: "50%" }}>
                  ...
                  <Input
                    ...
                    control={control}
                    errors={errors}
                    validate={errors?.mentors?.[index]?.email?.message}
                ...
                <div style={{ width: "50%" }}>
                  ...
                  <Input
                    ...
                    validate={errors?.mentors?.[index]?.password?.message}
                ...
                <div style={{ width: "50%" }}>
                  ...
                  <Input
                    ...
                    validate={
                      errors?.mentors?.[index]?.repeat_password?.message
                    }
