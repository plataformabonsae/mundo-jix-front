...
export const loginFetch = (type = 'talento', token, url = TALENT.AUTH.user) => async (dispatch) => {
...
export const logoutFetch = (type, token, url = TALENT.AUTH.logout) => async (dispatch) => {
