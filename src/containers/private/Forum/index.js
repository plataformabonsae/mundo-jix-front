        ...
        {!trail_type ? (
          <>
            ...
            <Text className={styles.warning}>
              ...
              Qualquer conteúdo postado aqui será compartilhado para todos os
              participantes, sejam eles de sua equipe ou não.
            </Text>
            <Card
              onClick={() => handleModal()}
              noShadow
            ...
            >
              <img
                src={
                  user?.user?.file ? BASEURL + user?.user?.file : defaultImage
                }
              ...
              <Card
                ...
                style={{ width: "100%" }}
              >
                <img style={{ borderRadius: 0 }} src={edit} alt={"Editar"} />
